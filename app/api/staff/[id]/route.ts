  ...
  try {
    ...
    const doc = await Staff.findByIdAndUpdate(
      params.id,
      {
        ...
        salaryAmount: Number(body.monthlySalary) || 0,
        salaryPercent: Number(body.salaryPercent) || 0,
        salaryOverride: body.salaryOverride !== undefined ? Number(body.salaryOverride) : undefined,
        overrideVisible: body.overrideVisible !== undefined ? !!body.overrideVisible : true,
